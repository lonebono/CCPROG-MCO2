...
public class ReserveSystem {
    ...
    public void manageHotel(String hotelName) {
        Hotel selectedHotel = getHotel(hotelName);
        if (selectedHotel != null) {
            // Add methods to manage the selected hotel, such as adding rooms, updating prices, canceling reservations, etc.
            // For example:
            // selectedHotel.addRoom(new Room(...));
            // selectedHotel.updatePrice(...);
